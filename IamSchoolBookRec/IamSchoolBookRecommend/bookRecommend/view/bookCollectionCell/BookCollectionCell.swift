...
class BookCollectionCell: UITableViewCell {
    ...
    var viewModel: BookCollectionData? {
        didSet {
...
extension BookCollectionCell: UICollectionViewDataSource {
...
extension BookCollectionCell: UICollectionViewDelegateFlowLayout {
